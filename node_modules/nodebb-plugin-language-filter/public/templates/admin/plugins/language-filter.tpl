            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p>Posts shorter than this many characters will skip language detection and always be allowed through. Must be greater than or equal to the <a href="{relative_path}/admin/settings/post">minimum post length</a> (currently <strong id="min-post-length-display">{minPostLength}</strong> characters).</p>
